...
import com.maxbendicion.repository.ClienteRepository;
...
public class ClienteController {
	...
	public ResponseEntity<Cliente> createClientes(@RequestBody Cliente clie) {
		try {
			Cliente _cliente = clienteRepository.save(new 
					Cliente(clie.getCedulacliente(), 
							clie.getDireccioncliente(),
							clie.getEmailcliente(), 
							clie.getNombrecliente(), 
							clie.getTelefonocliente()));
